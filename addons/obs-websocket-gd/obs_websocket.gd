...
class Identify extends ClientObsMessage:
	...
	func _init(p_rpc_version: int,p_authentication: String,p_event_subscriptions: int = OpCodeEnums.EventSubscription.All.IDENTIFIER_VALUE | OpCodeEnums.EventSubscription.InputVolumeMeters.IDENTIFIER_VALUE):
		op = 1
...
@export var poll_time: float = 0.04
